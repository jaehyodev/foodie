	...
	<section class="shoping-cart spad">
		<div class="container">
				...
				<div class="col-lg-12">
					<div class="shoping__cart__table">
							...
							<tbody>
								...
								<c:forEach items="${ingre_list}" var="ingre">
									<tr>
										...
										<td class="shoping__cart__total">${ingre_price }원</td>
										<!-- 해당항목삭제 -->
										<td class="shoping__cart__item__close"><a href=""><span
												class="icon_close"></span></a></td>
									</tr>
								</c:forEach>
						...
						<tr>
							...
							<td class="shoping__cart__total">15200원</td>
							<td class="shoping__cart__item__close"><span
								class="icon_close"></span></td>
						</tr>
						...
						<tr>
							...
							<td class="shoping__cart__total">5300원</td>
							<td class="shoping__cart__item__close"><span
								class="icon_close"></span></td>
						</tr>
						</tbody>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="shoping__cart__btns">
						<a href="shopdetail" class="primary-btn cart-btn">쇼핑 계속하기</a> <a
							href="#" class="primary-btn cart-btn cart-btn-right"><span
							class="icon_loading"></span> 장바구니 수정</a>
					</div>
				</div>
