               ...
               <div class="register-container">
                  <div class="mypage__content">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="id" name="mem_id" placeholder="아이디를 입력하세요" required>
                        </div>

                        <div class="form-group">
                           <label for="password">비밀번호</label>
                           <input type="password" class="form-control" id="pw" name="mem_pw" placeholder="비밀번호를 입력하세요" required>
                        </div>

                        <div class="form-group">
                           <label for="pwck">비밀번호 확인</label>
                           <label id="label2"></label>
                           <input type="password" class="form-control" id="pwck" name="mem_pwck" placeholder="비밀번호를 다시 입력하세요" required>
                        </div>

                        <div class="form-group">
                           <label for="name">이름</label>
                           <label id="label2-1"></label>
                           <input type="text" class="form-control" id="name" name="mem_name" placeholder="이름를 입력하세요" required>
                        </div>

                        <div class="form-group">
                           <label for="email">이메일</label>
                           <label id="label3"></label>
                           <input type="email" class="form-control" id="email" name="mem_email" placeholder="이메일을 입력하세요" required>
                        </div>
                           ...
                           <div class="form-group">
                               ...
                               <div class="phone-input-group">
                                  ...
                                  <span>-</span>
                                  <input type="tel" class="form-control" id="tel2" name="mem_tel2" maxlength="4" required>
                                  <span>-</span>
                                  <input type="tel" class="form-control" id="tel3" name="mem_tel3" maxlength="4" required>
                              </div>
                           </div>
