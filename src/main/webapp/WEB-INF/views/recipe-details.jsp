...
<body>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6">
					<div class="product__details__text">
						...
						<br></br> <a href="#" class="heart-icon"><span
						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="tabs-3" role="tabpanel">
								<div class="product__details__tab__desc">
									...
									<p>3. 중불로 달군 팬에 올리브유를 두르고 다진 마늘을 넣어 향이 올라오면 양파와 양배추를 넣고
										볶아주세요.</p>
			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						...
						<div class="product__item__pic set-bg"
							data-setbg="resources/img/product/cabbage.jpg">
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						<input class="check" type="checkbox" checked></input>
						<div class="product__item__pic set-bg"
							data-setbg="resources/img/product/garlic.jpg">
							<ul class="product__item__pic__hover">
								<li><a href="#"><i class="fa fa-heart"></i></a></li>
								<li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
							</ul>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						<input class="check" type="checkbox" checked></input>
						<div class="product__item__pic set-bg"
							data-setbg="resources/img/product/onion.jpg">
							<ul class="product__item__pic__hover">
								<li><a href="#"><i class="fa fa-heart"></i></a></li>
								<li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
							</ul>
			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						<input class="check" type="checkbox" checked></input>
						<div class="product__item__pic set-bg"
							data-setbg="resources/img/product/oyster_sauce.jpg">
							<ul class="product__item__pic__hover">
								<li><a href="#"><i class="fa fa-heart"></i></a></li>
								<li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
							</ul>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						<input class="check" type="checkbox" checked></input>
						<div class="product__item__pic set-bg"
							data-setbg="resources/img/product/brownrice.jpg">
							<ul class="product__item__pic__hover">
								<li><a href="#"><i class="fa fa-heart"></i></a></li>
								<li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
							</ul>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						<input class="check" type="checkbox" checked></input>
						<div class="product__item__pic set-bg"
							data-setbg="resources/img/product/olive_oil.jpg">
							<ul class="product__item__pic__hover">
								<li><a href="#"><i class="fa fa-heart"></i></a></li>
								<li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
							</ul>
	...
	<section class="related-product">
		<div class="container">
			...
			<a href="#" class="primary-btn float-center">선택 상품 장바구니 담기</a> <br></br>
		</div>
	</section>
